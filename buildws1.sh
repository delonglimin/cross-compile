...
#
  ...
  cd zlib-1.2.8
  PATH=$TOOLCHAIN_PATH:$PATH ./configure --static --prefix=./../zlib
...
function build_for_arm(){
  ...
  export HEADERS=$NDK/platforms/android-9/arch-arm/usr/include
  export LIBS=$NDK/platforms/android-9/arch-arm/usr/lib
